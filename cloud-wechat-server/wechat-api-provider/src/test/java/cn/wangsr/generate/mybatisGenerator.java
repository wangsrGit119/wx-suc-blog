...
public class mybatisGenerator {
    ...
    private static final String module = "wechat-api-provider";
     ...
     */
    public static DataSourceConfig getDataSourceConfig(String dbUrl,String userName, String password){
    ...
    public static void main(String[] args) {
        String dbUrl = "jdbc:mysql://49.235.135.130:3306/wechat_app_server?serverTimezone=UTC&characterEncoding=utf8&useUnicode=true&useSSL=false";
        String userName = "wangsr";
        String pwd = "wangsrGit119#";
        String[] tableNames={"article_info"};

        //关闭默认 xml  service impl  controller生成  调整使用自定义配置  getInjectionConfig()
        ...
        mpg.setGlobalConfig(getGlobalConfig())
                //获取数据源配置
                .setDataSource(getDataSourceConfig(dbUrl,userName,pwd))
                //模板引擎配置
